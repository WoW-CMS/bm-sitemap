              ...
              <div class="uk-grid-small uk-margin-small" uk-grid>
                <div class="uk-width-1-1">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="name" value="<?= $sitemap->module ?>" placeholder="<?= lang('name') ?>" autocomplete="off">
                  </div>
                ...
                <div class="uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" type="text" name="url" value="<?= $sitemap->url ?>" placeholder="<?= lang('url') ?>" autocomplete="off">
                    </div>
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select tail-single" id="select_priority" name="select_priority" autocomplete="off" data-placeholder="<?= lang('select_priority') ?>">
                        <?php foreach ($priorityOptions as $priorityValue => $priorityDescription): ?>
                            <option value="<?= $priorityValue ?>" <?= set_select('select_priority', $sitemap->priority, $sitemap->priority === $priorityValue) ?>><?= lang($priorityDescription) ?></option>
                        <?php endforeach ?>
                    </select>
                  </div>
